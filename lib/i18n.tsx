...
const DICT = {
  en: {
    ...
    "checkout.selectRegion": "Select your region",
    "checkout.selectRegionFirst": "Select a region first",
    "checkout.city": "City",
    "checkout.selectCity": "Select your city",
    "checkout.selectCityFirst": "Select a city first",
    "checkout.township": "Township",
    "checkout.selectTownship": "Select your township",
    "checkout.address": "Delivery address",
    "checkout.paymentMethod": "Payment Method",
    "checkout.paymentMethodNote": "Choose how you'll pay for this order.",
    "checkout.scanToPay": "Scan with",
    "checkout.viewFullQr": "View full QR code",
    "checkout.saveImage": "Save image",
    "checkout.transferTo": "Transfer to",
    "checkout.copy": "Copy",
    "checkout.copied": "Copied",
    "checkout.paymentAccountNote": "Scan the QR code and pay the total below, then upload your payment receipt.",
    ...
    "checkout.preorderNotice": "Your order includes preorder items — these will take longer to ship.",
    "checkout.orderSummary": "Order Summary",
    "checkout.shipping": "Shipping",
    "checkout.shippingDependsOnProvider": "Depends on delivery provider",
    "checkout.total": "Total",
    "checkout.orderPlaced": "Order placed",
    "checkout.thanks": "Thanks — we'll confirm your order once payment is verified.",
    "checkout.downloadInvoice": "Download Invoice",
  ...
  my: {
    ...
    "checkout.title": "Checkout",
    "checkout.backToCart": "ခြင်းတောင်းသို့ ပြန်သွားမည်",
    "checkout.stepCart": "ခြင်းတောင်း",
    ...
    "checkout.region": "တိုင်း/ပြည်နယ်",
    "checkout.selectRegion": "တိုင်း/ပြည်နယ် ရွေးပါ",
    "checkout.selectRegionFirst": "တိုင်း/ပြည်နယ်ကို အရင်ရွေးပါ",
    "checkout.city": "မြို့",
    "checkout.selectCity": "မြို့ရွေးပါ",
    "checkout.selectCityFirst": "မြို့ကို အရင်ရွေးပါ",
    "checkout.township": "မြို့နယ်",
    "checkout.selectTownship": "မြို့နယ်ရွေးပါ",
    "checkout.address": "ပို့ဆောင်ရမည့်လိပ်စာ",
    "checkout.paymentMethod": "ငွေပေးချေမှုနည်းလမ်း",
    "checkout.paymentMethodNote": "ဤအော်ဒါအတွက် မည်သို့ငွေပေးချေမည်ကို ရွေးချယ်ပါ။",
    "checkout.scanToPay": "ဖြင့် Scan ဖတ်ပါ",
    "checkout.viewFullQr": "QR code အပြည့်ကြည့်ရန်",
    "checkout.saveImage": "ပုံသိမ်းရန်",
    "checkout.transferTo": "ဤသို့လွှဲပါ",
    "checkout.copy": "ကူးရန်",
    "checkout.copied": "ကူးပြီး",
    "checkout.paymentAccountNote": "QR code ကို Scan ဖတ်ပြီး အောက်ပါစုစုပေါင်းငွေကို ပေးချေပါ၊ ထို့နောက် ငွေလွှဲပြေစာကို တင်ပေးပါ။",
    ...
    "checkout.preorderNotice": "သင့်အော်ဒါတွင် ကြိုတင်မှာယူထားသော ပစ္စည်းများ ပါဝင်ပါသည် — ပို့ဆောင်ရန် အချိန်ပိုကြာနိုင်ပါသည်။",
    "checkout.orderSummary": "အော်ဒါအကျဉ်းချုပ်",
    "checkout.shipping": "ပို့ဆောင်ခ",
    "checkout.shippingDependsOnProvider": "ပို့ဆောင်ရေး Provider ပေါ်မူတည်သည်",
    ...
    "checkout.downloadInvoice": "Invoice ဒေါင်းလုတ်ရယူရန်",
    "checkout.emptyTitle": "Checkout လုပ်စရာ မရှိပါ",
    "checkout.emptyBody": "သင့်ခြင်းတောင်း ဗလာဖြစ်နေပါသည်။",
