...
const DICT = {
  en: {
    ...
    "checkout.paymentAccountNote": "We'll contact you with the account details to transfer to before your order ships.",
  ...
  my: {
    ...
    "checkout.paymentAccountNote": "အော်ဒါမပို့မီ လွှဲရမည့် အကောင့်အချက်အလက်ကို ဆက်သွယ်ပေးပါမည်။",
